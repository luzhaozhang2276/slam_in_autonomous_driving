...
#ifndef SLAM_IN_AUTO_DRIVING_ICP_INC_H
#define SLAM_IN_AUTO_DRIVING_ICP_INC_H
...
class IncIcp3d {
   ...
   private:
    ...
    KD_TREE<sad::PointType>::Ptr ikdtree_ptr = nullptr;  // 第5章的ikdtree
...
#endif  // SLAM_IN_AUTO_DRIVING_ICP_INC_H
