...
class KD_TREE {
   ...
   public:
    ...
    bool GetClosestPoint(const PointType &pt, PointVector &Nearest_Points, int k);
    bool GetClosestPointMT(const PointVector &cloud, std::vector<std::pair<size_t, size_t>> &matches, int k);
